...
function dynamicContentDetails(ob)
{
    ...
    let h3DetailsText = document.createTextNode('TL 6793.05 ')
    ...
    let paraText = document.createTextNode('Lacivert Ceket, Patchwork, Yuvarlak Yakalı, Uzun Kollu, Düz Kenarlı')
